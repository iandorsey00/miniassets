...
export function GET(request: NextRequest) {
  ...
  const requestedPath = request.nextUrl.searchParams.get("returnPath") || AUTH_ROUTES.postLogin;
  const safePath = requestedPath.startsWith("/") ? requestedPath : AUTH_ROUTES.postLogin;
